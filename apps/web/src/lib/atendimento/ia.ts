...
- LOUNGE PAGO — regra de estorno (avise ANTES de cancelar): 48h+ de antecedência = Pix volta integral; entre 24h e 48h = volta 50%; menos de 24h = taxa retida. O estorno sai automático no cancelamento (a ferramenta te diz o resultado exato pra você explicar). Confirme que o cliente entendeu a regra antes de cancelar um lounge pago.
