// POST /api/conciliacao/automatica
// Body: { filialId, dataInicio, dataFim }
// Roda a cadeia inteira (Operadora → Recebíveis → Banco) e materializa a
// baixa por pagamento em conciliacao_pagamento. É o botão "Conciliar agora".
...
export async function POST(req: Request) {
  ...
  try {
    const r = await rodarConciliacaoAutomatica(parsed.data);
