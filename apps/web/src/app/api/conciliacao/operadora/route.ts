// POST /api/conciliacao/operadora
// Body: { filialId, dataInicio, dataFim }
// Cruza PDV x Vendas Cielo e persiste excecoes com processo='OPERADORA'.
...
import { rodarConciliacaoOperadora } from '@/lib/conciliacao-operadora';
...
export async function POST(req: Request) {
  ...
  try {
    const r = await rodarConciliacaoOperadora(parsed.data);
